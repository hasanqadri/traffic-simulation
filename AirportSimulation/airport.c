...
// R = time using runway when landing
// G = time on the ground residing at a terminal gate
#define	A	20.0
#define	R	5.0
#define	G	70.0
...
#Adding up the times for every traffic light other than the southbound one so we can increment the wait time
sum10 = [8+5+7, 1.8+3.6+3.6, 1.8+4.2+2.2, 30+28+34.7, 3.8+3.8+3.6, 55+55+49.3]
sum11 = [20.2+20.3+41.5, 3.6+3.6+3.2, 76.1+76.2+55.4]
sum12 = [27.3+27.3+60.9, 3.6+3.6+3.2, 69.2+69.2+35.7]
sum14 = [9.8+8.8, 3.6+3.6, 87+3.6, 36.9+22.4+34.6, 3.7+3.7+3.2, 60.2+74+46.1]
...
print(numOfCars1)
print(numOfCars14)
print(totalWaitingTime10)
print(totalWaitingTime11)
print(totalWaitingTime12)
print(totalWaitingTime14)
print(AverageWaitingTime10)
print(AverageWaitingTime11)
print(AverageWaitingTime12)
print(AverageWaitingTime14)
'''
